...
public class psi15_InteligentAgent extends Agent {
    ...
    private final double gamma = 0.9; //Discount factor that determines the importance of future rewards
    int statesCount;
    ...
    double[][] Q1;
    double[][] Q2;
    //double[][] Q3; relacion entre Q1 y Q2
    ...
    public class GameBehaviourRandom extends SimpleBehaviour {
        ...
        private void updateQ(boolean winner, int bet) {
            ...
            double oldbet = Q1[state][bet];
            double oldmycoins = Q2[state][mycoins];
           // System.out.println("MYCOINS IA" + mycoins);
            if (winner) {
...
//Calcula aleatoriamente la apuesta, excluyendo los numeros que ya han salido
    ...
    //Algoritmo de QLearning -> Estado inicial random (primera apuesta random) -> Si gana le aplicamos el reward, si pierde lo penalizamos..., si empata, no aplicamos la penalizacion
    ...
    int calculatebet() {
       ...
       System.out.println("///////////////POSIBLE ACTIONS: :" + Arrays.toString(actionsFromState.toArray()));
        ...
        for (int nextState : actionsFromState) {
         System.out.println("NEXTSTATE:" + nextState);
           ...
           System.out.println("//Q1 VALUEEEEEEEE : " + value);
                ...
                maxValue = value;
              //  System.out.println("//Q1 MaxValueeeeeeeeeeeee" + maxValue);
                policyGotoState = nextState;
            }
        }
